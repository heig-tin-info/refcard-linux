...
\begin{multicols}{4}
    ...
    \code{find . -type f -print0 | xargs -0 -n1 -P4 sha256sum} (parallèle) \\
    ...
    \begin{tabbing}
        ...
        \code|git switch -c br| \> crée \& bascule (nouveau) \\
        \code|git restore --staged [f]| \> retire de l'index \\
        \code|git stash -u| \> met de côté (inclut non suivis) \\
        \code|git cherry -v main| \> commits non poussés \\
        \code|git bisect start ...| \> recherche bogue binaire \\
